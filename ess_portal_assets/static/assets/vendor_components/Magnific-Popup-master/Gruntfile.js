...
"pygments: true \r\n";
  ...
  grunt.initConfig({
    ...
    sass: {                            
      dist: {                      
        files: {      
          'dist/magnific-popup.css': '/ess_portal_/ess_portal_assets/static/assets/static/src/css/main.scss'
        }
      }
    },
    ...
    jshint: {
      all: [
        'Gruntfile.js',
        '/ess_portal_/ess_portal_assets/static/assets/static/src/js/*.js'
      ],
      options: {
        jshintrc: '.jshintrc'
      }
    ...
    mfpbuild: {
      all: {
        ...
        basePath: '/ess_portal_/ess_portal_assets/static/assets/static/src/js/',
    ...
    cssmin: {
      compress: {
        files: {
          "website/site-/ess_portal_assets/static/assets/all.min.css": ["website/site-/ess_portal_assets/static/assets/site.css", "website/dist/magnific-popup.css"]
        }
      }
    }
